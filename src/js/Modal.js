...
export class Modal extends Component {
    ...
    render() {
        let modalBody, button, modalTitle;
            ...
            button = <Button variant="danger" onClick={this.props.deletePlayer()}>Delete</Button>
        return (
            <ModalMain show={this.props.show} onHide={this.props.openModal({})}>
                <ModalHeader closeButton>
                {modalTitle}
                </ModalHeader>
                {modalBody}
                <ModalFooter>
                    <Button variant="secondary" onClick={this.props.openModal({})}>
                        Close
                    </Button>
                    {button}
                </ModalFooter>
